...
/**
 * <p>Original entity name from the Odata EDM: <b>Summary_of_Sales_by_Quarter</b></p>
 * 
 */
@Builder
@Data
...
public class Summary_of_Sales_by_Quarter
    extends VdmEntity<Summary_of_Sales_by_Quarter>
    implements VdmEntitySet
{

    @Getter
    private final String odataType = "NorthwindModel.Summary_of_Sales_by_Quarter";
    /**
     * Selector for all available fields of Summary_of_Sales_by_Quarter.
     * 
     */
    public final static SimpleProperty<Summary_of_Sales_by_Quarter> ALL_FIELDS = all();
    /**
    ...
    public final static SimpleProperty.DateTime<Summary_of_Sales_by_Quarter> SHIPPED_DATE = new SimpleProperty.DateTime<Summary_of_Sales_by_Quarter>(Summary_of_Sales_by_Quarter.class, "ShippedDate");
    /**
    ...
    public final static SimpleProperty.NumericInteger<Summary_of_Sales_by_Quarter> ORDER_ID = new SimpleProperty.NumericInteger<Summary_of_Sales_by_Quarter>(Summary_of_Sales_by_Quarter.class, "OrderID");
    /**
    ...
    public final static SimpleProperty.NumericDecimal<Summary_of_Sales_by_Quarter> SUBTOTAL = new SimpleProperty.NumericDecimal<Summary_of_Sales_by_Quarter>(Summary_of_Sales_by_Quarter.class, "Subtotal");

    @Nonnull
    @Override
    public Class<Summary_of_Sales_by_Quarter> getType() {
        return Summary_of_Sales_by_Quarter.class;
    }
    ...
    protected String getEntityCollection() {
        return "Summary_of_Sales_by_Quarters";
    }

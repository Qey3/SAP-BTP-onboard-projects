...
import com.example.MyTenantApplication;
import com.example.configuration.SchemaPerTenantConnectionProvider;
...
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource,
        ...
        entityManager.setPackagesToScan(MyTenantApplication.class.getPackageName());
